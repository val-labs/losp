...
(define-easy-handler (bongo-html :uri "/2") ()
  (concat "<!doctype html>"
	  "<html>"   (uiop:read-file-string "www/ndx2.html")
	  "<style>"  (uiop:read-file-string "www/sit2.css") "</style>"
	  "<script>" (uiop:read-file-string "www/app2.js")   "</script>"
	  "</html>"))
